    ...
    <div className="min-h-screen bg-background relative">
      ...
      <div className="max-w-xl mx-auto px-4 -mt-8">
        <div className="bg-card border border-border rounded-2xl p-8 shadow-lg text-center">
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-foreground mb-4">Your AI Playbook Is On Its Way</h2>

          <p className="text-muted-foreground mb-2">
            Thank you for downloading the Practical AI Playbook for Entrepreneurs (2026).
          </p>
          <p className="text-muted-foreground mb-6">You'll receive the playbook in your inbox shortly.</p>

          {/* Guide Info */}
          <div className="text-left mb-8">
            <p className="text-foreground font-semibold mb-4">This guide is designed to be:</p>
